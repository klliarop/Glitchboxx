...
class FTPConfig(ExerciseConfig):
    ...
    **SCENARIO:** <br> **"You are a security analyst at “NeuroGen Biotech”, an organization specializing in biochemical research. 
    ...
    """, unsafe_allow_html=True)
            ...
            wordlist_path = os.path.join(CURRENT_DIR, "level2", "500-worst-passwords.txt")
            ...
            with st.form("ftp_config_form", clear_on_submit=False):
                ftp_user = st.text_input("Enter FTP Username", value="hello")
                ftp_pass = st.text_input("Enter FTP Password", type="password", value="access")
        ...
        if level == "Level 2 - Authenticated FTP":
